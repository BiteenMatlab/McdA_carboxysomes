...
% minimum merit
params.trackparams(1)=0.001;
% Integration time (ms)
params.trackparams(2)=20;
% gamma
params.trackparams(3)=0.25;
% maximum step size
params.trackparams(4)=2;
% minimum track length
params.trackparams(5)=4;
...
%        goodframes([dlocs{ii},filesep,dnames{ii},'.mat'],'inttime',20,'acttime',100,'manual',false);
% end
% end
